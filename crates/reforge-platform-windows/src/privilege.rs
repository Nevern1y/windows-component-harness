//! Constrained bridge to the separately packaged elevation helper.
//!
//! The UAC launch carries exactly a run ID and a fresh nonce. The operation ID
//! travels over a nonce-bound local named pipe; neither path accepts command
//! text, package paths, arguments, or environment data.
